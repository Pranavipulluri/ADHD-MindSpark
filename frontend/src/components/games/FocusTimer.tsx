...
const FocusTimer: React.FC<FocusTimerProps> = ({ isOpen, onClose }) => {
  ...
  const handleDistraction = () => {
    ...
    // Optional: pause timer on distraction
    // setIsRunning(false);
  };
          ...
          <div className="text-center">
            ...
            <div className="mb-4">
              ...
              >
                ...
                <span>{cameraEnabled ? 'Camera Monitoring: ON' : 'Camera Monitoring: OFF'}</span>
              </button>
            </div>
            ...
            <div className="text-center p-4 bg-gray-100 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Distractions caught: <span className="font-bold text-orange-600">{distractionCount}</span>
              </p>
              {completedSessions > 0 && (
            ...
            {!cameraEnabled && (
              <div className="bg-gray-100 rounded-lg p-8 text-center h-full flex items-center justify-center">
                <div>
                  ...
                  <p className="text-gray-600">Camera monitoring is disabled</p>
                  <p className="text-sm text-gray-500 mt-2">
                    Enable camera to track your focus and get alerts
                  </p>
                </div>
              </div>
            )}
